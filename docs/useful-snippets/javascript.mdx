...
import CriticalExample from '@site/src/components/CriticalExample';
...
:::info
The below snippet is actually a live example of this website's above the folder CSS. Cool right?!
:::
